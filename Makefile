...
obj/zones.o: src/zones.c headers/zones.h headers/structures.h
	gcc -Wall -Wextra -c src/zones.c -o obj/zones.o

obj/personnages.o: src/personnages.c headers/personnages.h headers/zones.h
...
obj/joueuses.o: src/joueuses.c headers/joueuses.h headers/personnages.h
	gcc -Wall -Wextra -c src/joueuses.c -o obj/joueuses.o

obj/interface.o: src/interface.c headers/interface.h headers/joueuses.h
	gcc -Wall -Wextra -c src/interface.c -o obj/interface.o

obj/structures.o: src/structures.c headers/structures.h headers/cartes.h
	gcc -Wall -Wextra -c src/structures.c -o obj/structures.o

obj/effets.o: src/effets.c headers/effets.h headers/interface.h
	gcc -Wall -Wextra -c src/effets.c -o obj/effets.o

obj/main.o: src/main.c headers/effets.h
